...
- [X] Do not paste long code blocks in chat instead of writing files.
- [X] Do not write tests after implementation that just rubber-stamp the code; write them in parallel and audit them against the spec.
