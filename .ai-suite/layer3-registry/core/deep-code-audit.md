...
description: Deep Code Quality & Architecture Audit Skill. Triggers a Staff-level multi-pass inspection for maintainability, security, performance, and defects.
globs: "*"
triggers:
  - deep code audit
  - code quality audit
